...
* @returns {Uint8Array}
*/
export function gen_circuit_settings_wasm(model_ser, run_args_ser) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray8ToWasm0(model_ser, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passArray8ToWasm0(run_args_ser, wasm.__wbindgen_malloc);
        const len1 = WASM_VECTOR_LEN;
        wasm.gen_circuit_settings_wasm(retptr, ptr0, len0, ptr1, len1);
...
* @returns {Uint8Array}
*/
export function gen_pk_wasm(circuit_ser, params_ser, circuit_settings_ser) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
* @returns {Uint8Array}
*/
export function gen_vk_wasm(pk, circuit_settings_ser) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
* @returns {boolean}
*/
export function verify_wasm(proof_js, vk, circuit_settings_ser, params_ser) {
...
* @returns {Uint8Array}
*/
export function prove_wasm(witness, pk, circuit_ser, circuit_settings_ser, params_ser) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
